...
Candy.Util = (function(self, $){
	...
	},
	{
		...
		return text.replace(/(\b(https?|ftp|file):\/\/[\-A-Z0-9+&@#\/%?=~_|!:,.;]*[\-A-Z0-9+&@#\/%=~_|])/ig, '<a class="message_link" href="$1" target="_blank">$1</a>');
	    },
...
Candy.View.Template = (function(self){
	...
	self.Room = {
	    ...
	    form: '<div class="message-form-wrapper"></div><form method="post" class="message-form"><input name="message" class="field" type="text" autocomplete="off" maxlength="1000" placeholder="Escribe aquí..."/><input type="submit" class="submit" name="submit" value="{{_messageSubmit}}" /></form>'
	};
